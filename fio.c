...
U wr(I d,S b,U n){U w=write(d,b,n);QQ(n-w,"write");R w;}
...
K map(S f,U*n,I d){ST(b);d=d?rwd(d,0):open(f,O_RDONLY,0);fstat(d,&b);S s=mmap(0,*n=b.st_size,PROT_READ|PROT_WRITE,MAP_PRIVATE,d,0);R close(d),(K)(16+s);}
